...
/**
 * A subs detector that performs a KNN outlier detection and computes scores
 * based on the distances to the kth neighbour.
 * The metric is used is the Euclidean distance on the metric spaces spanned by the numerical attributes
 * that are passed on.
 * @author abronsel
 * @param <I>
 */
public class KNNSubsDetector <I extends Comparable<? super I>> extends SubsDetector<I>
{
    private final int k;

    public KNNSubsDetector(int k, int window, double scoreThreshold)
    {
