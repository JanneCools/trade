...
"Software" shall mean "ledc (Lightweight Engine for Data quality Control) provided in Java code form" made available under the License, as indicated by a notice that is included in or attached to the Software.
